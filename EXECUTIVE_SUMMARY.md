...
### 什么是Snapshot？（给非Web3投资人）

**Snapshot = DAO治理的"问卷星"**
- 提案是JSON数据（标题、描述、选项），不是智能合约
- 用户**签名**（Sign）投票，不上链、**0 gas费**
- 80%的DAO用它（Uniswap、Arbitrum、ENS）
- 投票通过后，多签钱包人工执行

**对比**：链上治理（如Compound）需要付$5-50 gas费，合约自动执行
...
| 高级订阅 | $9/月 Pro版 | 20% |
| DAO付费推广 | 提案置顶 | 20% |
| 交易所合作 | Token购买引导，CPA $10-30/人 | 15% |
| 数据API | 向项目方提供治理数据 | 12% |
| $VOTE代币 | 手续费回购、质押、治理 | 8% |
...
### 交易所合作新模式
当用户发现"需要持有代币才能投票"时，我们成为**Token购买的最佳入口**
- 与Binance、Coinbase等合作嵌入"Buy Token"按钮
- 精准流量：用户已有明确购买意图（非投机者）
- 为交易所带来新用户+交易量，我们获得CPA收入
